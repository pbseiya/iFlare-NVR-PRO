...
export default function SettingsPage() {
    ...
    return (
        <div className="flex h-[calc(100vh-64px)] bg-gray-50/50">
            {/* Sidebar Navigation */}
            <div className="w-64 border-r border-gray-200 bg-white p-6 flex flex-col gap-1 hidden md:flex">
            ...
            <div className="md:hidden w-full overflow-x-auto bg-white border-b border-gray-200 p-2 flex gap-2">
                <button onClick={() => setActiveTab('general')} className={`px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap ${activeTab === 'general' ? 'bg-blue-50 text-blue-700' : 'text-slate-600'}`}>General</button>
                <button onClick={() => setActiveTab('display')} className={`px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap ${activeTab === 'display' ? 'bg-blue-50 text-blue-700' : 'text-slate-600'}`}>Display</button>
                <button onClick={() => setActiveTab('storage')} className={`px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap ${activeTab === 'storage' ? 'bg-blue-50 text-blue-700' : 'text-slate-600'}`}>Storage</button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto">
                <div className="max-w-4xl mx-auto p-8 pb-20 space-y-8">
                    ...
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            <h1 className="text-2xl font-bold text-slate-900 capitalize">{activeTab} Settings</h1>
                        ...
                        <div className="space-y-6">
                            ...
                            <section className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                                <div className="p-6 border-b border-gray-100">
                                    ...
                                    <p className="text-sm text-slate-500">Core system behavior and power options</p>
                                </div>
                                <div className="p-6 space-y-6">
                                    <div className="flex items-start justify-between">
                                        <div className="space-y-1">
                                            <span className="font-medium text-slate-900 block">Auto-Resume Live Sessions</span>
                                    ...
                                    <div className="border-t border-gray-100 pt-6">
                                        ...
                                        <select disabled className="w-full max-w-sm p-2.5 bg-gray-50 border border-gray-300 text-gray-400 rounded-lg text-sm cursor-not-allowed">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 flex items-center gap-4">
                                ...
                                <div className="flex-1">
                                    <label className="block text-sm font-medium text-slate-700 mb-1">Target Camera Context</label>
                                    <select
                            ...
                            <section className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                                <div className="p-6 border-b border-gray-100 flex items-center justify-between">
                                    <div>
                                        <h3 className="text-lg font-semibold text-slate-900 mb-1">Inference Overlay</h3>
                                        <p className="text-sm text-slate-500">Customize bounding boxes and labels</p>
                                    </div>
                            ...
                            <section className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                                <div className="p-6 border-b border-gray-100">
                                    <h3 className="text-lg font-semibold text-slate-900 mb-1">Apply Scope</h3>
                                    <p className="text-sm text-slate-500">Where should these custom overlay settings be applied?</p>
                                </div>
                                <div className="p-6 space-y-3">
                                    {[
                                        ...
                                        <label key={item.key} className="flex items-center gap-4 p-3 rounded-lg border border-slate-200 hover:bg-slate-50 cursor-pointer transition-colors">
                                            <input
                                                type="checkbox"
                                            ...
                                            />
                                            <div>
                                                <span className="font-medium text-slate-700 block">{item.label}</span>
                    ...
                    {(activeTab === 'storage' || activeTab === 'notifications') && (
                        <div className="flex flex-col items-center justify-center py-20 bg-white rounded-xl border border-gray-200 border-dashed">
                            ...
                            <h3 className="text-lg font-medium text-slate-900 capitalize">{activeTab} Settings</h3>
                            <p className="text-slate-500 mt-1">This feature is coming soon.</p>
                        </div>
                    )}
                </div>
            </div>
